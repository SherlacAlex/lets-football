<template>
  <div class="space-y-8">
    ...
    <div
      v-else
      class="bg-slate-900/40 border border-slate-800/80 rounded-3xl overflow-hidden backdrop-blur-md"
    >
...
const {
  ...
  transform: (data) => normalizeUserLeagues(data as UserLeague[] | null),
})
