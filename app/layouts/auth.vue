<template>
  <div class="flex h-screen bg-slate-950 text-white font-sans overflow-hidden">
    <!-- Sidebar Navigation -->
    <nav class="w-20 md:w-64 bg-slate-900 border-r border-slate-800 flex flex-col justify-between transition-all duration-300">
      <div class="flex flex-col">
        ...
        <div class="h-20 flex items-center justify-center md:justify-start px-6 border-b border-slate-800">
          <NuxtLink to="/" class="flex items-center space-x-3 group">
            ...
            <span class="hidden md:block text-lg font-black tracking-tight bg-gradient-to-r from-white via-slate-100 to-emerald-400 bg-clip-text text-transparent">
              LET'S FOOTBALL
            </span>
          </NuxtLink>
        </div>
        ...
        <div class="p-4 space-y-2">
          ...
          <NuxtLink 
            ...
            <span class="hidden md:inline text-sm">Leaderboard</span>
          </NuxtLink>
    ...
    <main class="flex-1 flex flex-col overflow-y-auto bg-slate-950">
      ...
      <div class="h-20 border-b border-slate-900 px-8 flex items-center justify-between bg-slate-950/40 backdrop-blur-sm">
