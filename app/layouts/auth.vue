<template>
  <div class="flex h-[100dvh] bg-slate-950 text-white font-sans overflow-hidden">
    <!-- Desktop sidebar -->
    <nav class="hidden md:flex md:w-64 bg-slate-900 border-r border-slate-800 flex-col justify-between shrink-0">
        ...
        <div class="h-16 lg:h-20 flex items-center px-4 lg:px-6 border-b border-slate-800 shrink-0">
          <NuxtLink to="/" class="flex items-center gap-3 group min-w-0">
            <div
              ...
              <img src="/world-cup.svg" alt="" class="h-6 w-6 object-contain object-top" />
            </div>
            <span
    ...
    <main class="flex-1 flex flex-col min-w-0 overflow-hidden">
      <header
        ...
        <div class="flex items-center gap-3 min-w-0 md:hidden">
          <div class="bg-white p-1 rounded-lg shadow-lg shadow-emerald-500/20 shrink-0">
            <img src="/world-cup.svg" alt="" class="h-5 w-5 object-contain object-top" />
          </div>
        ...
        <button type="button" class="relative p-2 text-slate-400 hover:text-white transition-colors shrink-0"
      ...
      <div
        class="flex-1 overflow-y-auto overflow-x-hidden px-4 py-4 md:px-6 md:py-6 lg:p-8 pb-[calc(4.75rem+env(safe-area-inset-bottom,0px))] md:pb-6 lg:pb-8">
