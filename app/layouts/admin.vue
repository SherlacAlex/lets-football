            ...
            <div
                ...
                <div class="flex items-center gap-8">
                    ...
                    <div class="hidden sm:flex items-center space-x-3">
                        <span class="text-sm font-semibold tracking-wider text-emerald-400 uppercase">World Cup
                            Predictions</span>
                        <span
                            class="px-2 py-0.5 text-xs font-bold rounded-full bg-emerald-500/10 text-emerald-400">Live</span>
                    </div>
                </div>
                <div class="flex items-center space-x-4">
                    <button class="relative p-2 text-slate-400 hover:text-white transition-colors">
                        ...
                        <span
                            class="absolute top-1.5 right-1.5 w-2 h-2 rounded-full bg-emerald-500 animate-pulse"></span>
                    </button>
                </div>
            </div>
