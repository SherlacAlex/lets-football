  ...
  app: {
    head: {
      ...
      meta: [
        ...
        { property: 'og:title', content: "Let's Football — FIFA World Cup 2026 Prediction Game" },
        { property: 'og:description', content: siteDescription },
        { property: 'og:locale', content: 'en_US' },
        { name: 'twitter:card', content: 'summary_large_image' },
        { name: 'twitter:title', content: "Let's Football — FIFA World Cup 2026 Prediction Game" },
